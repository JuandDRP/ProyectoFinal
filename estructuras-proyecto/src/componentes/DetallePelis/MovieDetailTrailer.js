    ...
    return (
        <div>
            ...
            <label htmlFor="my-modal-4" className="modal cursor-pointer">
                <iframe src={videoUrl} title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className=" w-4/5 lg:w-3/5 aspect-video" ref={videoRef}></iframe>
            </label>
        </div>
    )
}
